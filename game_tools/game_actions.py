...
class Actions:
    ...
    def game_key_hold(key: str, hold_ms: int = None, retrigger: bool = True, release_on_stop: bool = True): """Hold a key indefinitely or for a fixed duration e.g. game_key_hold(\"space\", 500)"""; game_key_hold(key, hold_ms, retrigger, release_on_stop)
