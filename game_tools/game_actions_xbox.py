...
class Actions:
    ...
    def game_xbox_left_stick_raw(x: float, y: float): """Set left stick raw x and y values -1.0 to 1.0"""; actions.user.vgamepad_left_stick(x, -y)
    ...
    def game_xbox_right_stick_raw(x: float, y: float): """Set right stick raw x and y values -1.0 to 1.0"""; actions.user.vgamepad_right_stick(x, -y)
