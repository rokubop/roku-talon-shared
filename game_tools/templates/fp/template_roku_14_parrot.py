...
parrot_config = {{
    ...
    "shush":      ("jump", lambda: actions.user.game_key_hold("z")),
    "shush_stop:db_200": ("", lambda: actions.user.game_key_release("z")),
    "hiss:th_100":("", lambda: actions.user.game_key("x")),
    "hiss_stop":  ("", lambda: None),
    "er":         ("exit mode", actions.user.game_mode_disable),
    "tut t":      ("map", lambda: actions.user.game_key_hold("tab")),
    "tut cluck":  ("hold a", lambda: actions.user.game_key_hold("a")),
}}
