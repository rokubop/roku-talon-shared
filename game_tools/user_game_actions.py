...
from .src.game_core import (
    ...
    game_key_toggle,
    game_key_release,
    game_arrows_dir_hold_down_horizontal,
    game_dir_hold_last_horizontal,
    game_arrows_dir_hold_up_horizontal,
...
class Actions:
    ...
    def game_key_press(key: str): """Press a key"""; game_key(key)
    ...
    def game_wasd_dir_hold(key: str): """Start holding a custom direction. Mutually exclusive."""; move_dir(key)
    def game_wasd_dir_hold_a(): """Start holding direction 'a'. Mutually exclusive."""; move_dir('a')
    def game_wasd_dir_hold_d(): """Start holding direction 'd'. Mutually exclusive."""; move_dir('d')
    def game_wasd_dir_hold_w(): """Start holding direction 'w'. Mutually exclusive."""; move_dir('w')
    def game_wasd_dir_hold_s(): """Start holding direction 's'. Mutually exclusive."""; move_dir('s')
    def game_wasd_dir_hold_a_curved(initial_curve_speed: int = 5): """Start holding direction 'a' with an adjustable curve. Mutually exclusive."""; move_dir_curve('a', initial_curve_speed)
    def game_wasd_dir_hold_d_curved(initial_curve_speed: int = 5): """Start holding direction 'd' with an adjustable curve. Mutually exclusive."""; move_dir_curve('d', initial_curve_speed)
    def game_wasd_dir_hold_w_a(): """Start holding direction 'w' and 'a'"""; move_dir(('w', 'a'))
    def game_wasd_dir_hold_w_d(): """Start holding direction 'w' and 'd'"""; move_dir(('w', 'd'))
    def game_wasd_dir_hold_s_a(): """Start holding direction 's' and 'a'"""; move_dir(('s', 'a'))
    def game_wasd_dir_hold_s_d(): """Start holding direction 's' and 'd'"""; move_dir(('s', 'd'))
    def game_arrows_dir_hold_left(): """Start holding direction 'left'. Mutually exclusive."""; move_dir('left')
    def game_arrows_dir_hold_right(): """Start holding direction 'right'. Mutually exclusive."""; move_dir('right')
    def game_arrows_dir_hold_up(): """Start holding direction 'up'. Mutually exclusive."""; move_dir('up')
    def game_arrows_dir_hold_down(): """Start holding direction 'down'. Mutually exclusive."""; move_dir('down')
    def game_arrows_dir_hold_up_left(): """Start holding direction 'up' and 'left'"""; move_dir(('up', 'left'))
    def game_arrows_dir_hold_up_right(): """Start holding direction 'up' and 'right'"""; move_dir(('up', 'right'))
    def game_arrows_dir_hold_up_horizontal(): """Start holding direction 'up' and last 'left' or 'right'"""; game_arrows_dir_hold_up_horizontal()
    def game_arrows_dir_hold_down_left(): """Start holding direction 'down' and 'left'"""; move_dir(('down', 'left'))
    def game_arrows_dir_hold_down_right(): """Start holding direction 'down' and 'right'"""; move_dir(('down', 'right'))
    def game_arrows_dir_hold_down_horizontal(): """Start holding direction 'down' and last 'left' or 'right'"""; game_arrows_dir_hold_down_horizontal()
    ...
    def game_wasd_dir_toggle(key: str): """Toggle between stop and holding direction"""; move_dir_toggle(key)
    def game_wasd_dir_toggle_a(): """Toggle between stop and holding direction 'a'"""; move_dir_toggle('a')
    def game_wasd_dir_toggle_d(): """Toggle between stop and holding direction 'd'"""; move_dir_toggle('d')
    def game_wasd_dir_toggle_w(): """Toggle between stop and holding direction 'w'"""; move_dir_toggle('w')
    def game_wasd_dir_toggle_s(): """Toggle between stop and holding direction 's'"""; move_dir_toggle('s')
    ...
    def game_mouse_move_deg_left_60(mouse_button: int = None): """Turn left 60 degrees; Optionally specify mouse button 0=left, 1=right, 2=middle to hold"""; mouse_move_deg(-60, 0, mouse_button)
    ...
    def game_mouse_move_deg_right_60(mouse_button: int = None): """Turn right 60 degrees; Optionally specify mouse button 0=left, 1=right, 2=middle to hold"""; mouse_move_deg(60, 0, mouse_button)
    ...
    def game_mouse_move_deg_up_60(mouse_button: int = None): """Look up 60 degrees"""; mouse_move_deg(0, -60)
    ...
    def game_mouse_move_deg_down_60(mouse_button: int = None): """Look down 60 degrees"""; mouse_move_deg(0, 60)
    ...
    def game_calibrate_x_360(num: int, mouse_button: int = None): """Calibrate x by testing a 360"""; game_calibrate_x_360(num)
    def game_calibrate_y_90(num: int, mouse_button: int = None): """Calibrate y by testing ground to center"""; game_calibrate_90_y(num)