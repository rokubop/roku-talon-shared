...
class Actions:
    ...
    def game_look_up_continuous(speed: int = 20): """Look up continuously at speed x"""; actions.user.mouse_move_continuous(0, -1, speed)
    ...
    def game_look_down_continuous(speed: int = 20): """Look down continuously at speed x"""; actions.user.mouse_move_continuous(0, 1, speed)
