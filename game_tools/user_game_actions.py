...
class Actions:
    ...
    def game_turn_left(deg: int = 90): """Turn left x degrees"""; mouse_move_deg(-deg, 0 )
    ...
    def game_turn_right(deg: int = 90): """Turn right x degrees"""; mouse_move_deg(deg, 0 )
    def game_turn_right_continuous(speed: int = 20): """Turn right continuously at speed x"""; actions.user.mouse_move_continuous(1, 0, speed)
    ...
    def game_turn_left_continuous(speed: int = 20): """Turn left continuously at speed x"""; actions.user.mouse_move_continuous(-1, 0, speed)
    ...
    def game_turn_continuous_stop(): """Stop turning continuously"""; actions.user.mouse_move_continuous_stop(150)
    def game_turn_180(): """Turn 180"""; mouse_move_deg(180, 0)
    def game_turn_360(): """Turn 360"""; mouse_move_deg(360, 0, 1500)
    def game_look_up_continuous(speed: int = 10): """Look up continuously at speed x"""; actions.user.mouse_move_continuous(0, -1, speed)
    ...
    def game_look_down_continuous(speed: int = 10): """Look down continuously at speed x"""; actions.user.mouse_move_continuous(0, 1, speed)
    ...
    def game_look_continuous_stop(): """Stop looking continuously"""; actions.user.mouse_move_continuous_stop(150)
    ...
    def game_look_up(deg: int = 20): """Look up y degrees"""; mouse_move_deg(0, -deg)
    ...
    def game_look_down(deg: int = 20): """Look down y degrees"""; mouse_move_deg(0, deg)
    ...
    def game_calibrate_x_360(num: int): """Calibrate x by testing a 360"""; mouse_calibrate_x_360(num)
    def game_calibrate_y_90(num: int): """Calibrate y by testing ground to center"""; mouse_calibrate_90_y(num)
