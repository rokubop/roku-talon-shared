...
class Actions:
    ...
    def game_mouse_click(button: int = 0, duration_ms: int = 16): """Mouse click; 0=left, 1=right, 2=middle"""; mouse_click(button, duration_ms)
    def game_mouse_click_left(duration_ms: int = 16): """Left click"""; mouse_click(0, duration_ms)
    def game_mouse_click_right(duration_ms: int = 16): """Right click"""; mouse_click(1, duration_ms)
    def game_mouse_click_middle(duration_ms: int = 16): """Middle click"""; mouse_click(2, duration_ms)
