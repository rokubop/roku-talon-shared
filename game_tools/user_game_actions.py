...
from .src.game_core import move_dir, step_dir, move_dir_toggle, stopper, mouse_calibrate_90_y, mouse_calibrate_x_360, mouse_reset_center_y, game_key, game_key_hold
from .src.game_ui_controls import ui_dpad_left, ui_dpad_right, ui_dpad_up, ui_dpad_down, ui_dpad_stop
...
class Actions:
    ...
    def game_move_dir_hold_a(): """Start holding direction 'a'"""; move_dir('a'); ui_dpad_left()
    def game_move_dir_hold_d(): """Start holding direction 'd'"""; move_dir('d'); ui_dpad_right()
    def game_move_dir_hold_w(): """Start holding direction 'w'"""; move_dir('w'); ui_dpad_up()
    def game_move_dir_hold_s(): """Start holding direction 's'"""; move_dir('s'); ui_dpad_down()
    def game_move_dir_hold_left(): """Start holding direction 'left'"""; move_dir('left'); ui_dpad_left()
    def game_move_dir_hold_right(): """Start holding direction 'right'"""; move_dir('right'); ui_dpad_right()
    def game_move_dir_hold_up(): """Start holding direction 'up'"""; move_dir('up'); ui_dpad_up()
    def game_move_dir_hold_down(): """Start holding direction 'down'"""; move_dir('down'); ui_dpad_down()
    ...
    def game_stopper(): """All purpose stopper for movement and mouse"""; stopper(); ui_dpad_stop()
    def game_stop_all(): """Stop all movement and mouse actions"""; stopper(); ui_dpad_stop()
    ...
    def game_ui(): """Override this in ctx for specific UI options"""; return {}