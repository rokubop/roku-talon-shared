...
class EntityVisitor(ParentNodeVisitor):
    ...
    def visit_Attribute(self, node):
        ...
        if isinstance(node.value, ast.Attribute):
            if node.value.attr in {'user', 'edit', 'core'}:
    ...
    def visit_Call(self, node):
        try:
            ...
            if isinstance(node.func, ast.Attribute) and isinstance(node.func.value, ast.Attribute):
                if node.func.value.attr in ['user', 'edit', 'core']:
...
def entity_extract(folder_path: str) -> AllEntities:
    """
    This function can be called externally to extract manifest data from a folder.
    """
...
#     try:
#         all_entity_data = entity_extract(folder_path)
#         print("Contributes:")
#         print(all_entity_data.contributes)
#         print("Depends:")
#         print(all_entity_data.depends)
