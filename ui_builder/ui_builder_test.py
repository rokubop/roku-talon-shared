...
class Actions:
    ...
    def ui_builder_test():
        ...
        box.add_text("Hello World!", size=32, padding_top=16, color="dd6666")
        box.add_text("Goodbye World!")
        box.add_text("Click Me!", background_color="666666", padding_y=16, padding_x=32, size=24, color="blue")
        builder.show()
